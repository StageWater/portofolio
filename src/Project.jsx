...
const dummyProjects = [
  {
    ...
    description: "Merancang dan membangun sistem informasi transaksi penjualan pulsa, paket data, dan token listrik. Aplikasi ini dilengkapi dengan rekapitulasi laporan keuangan otomatis serta manajemen saldo inventaris.",
    techStack: ["Python", "Flask", "MySQL", "Bootstrap"], 
    githubLink: "https://github.com/StageWater/web-portfolio", 
    liveLink: "#", 
    image: "/images/pulsa-project.png"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    role: "UI/UX Designer",
    description: "Perancangan antarmuka personal portofolio modern berorientasi pengguna (user-centric design) hasil studi kasus Workshop SIBARMATI.",
  ...
  },
  {
    ...
    role: "Data Analyst",
    description: "Melakukan eksplorasi, pra-pemrosesan data, dan rekayasa fitur pada dataset perilaku konsumen menggunakan algoritma supervised learning untuk memprediksi tingkat retensi.",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {dummyProjects.map((project) => (
            ...
            >
              <div>
                {/* INI ADALAH BAGIAN KOTAK GAMBAR YANG BARU */}
                <div className="relative h-48 md:h-56 w-full overflow-hidden bg-slate-900 border-b border-slate-800">
                  <img 
                    src={project.image} 
                    alt={project.title}
